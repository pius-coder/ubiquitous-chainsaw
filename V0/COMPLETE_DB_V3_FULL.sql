...
\restrict yv1TsoF2IPNGfl7mr4Oa2ay9weCw2kBtG7l2aYOVXjB5oyKZgzmPndctaIff1oo
...
CREATE TABLE public.search_cache (
    ...
    search_type character varying(30) DEFAULT 'profile'::character varying,
    created_at timestamp with time zone DEFAULT now(),
...
--
-- Name: workflow_config_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.workflow_config_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: workflow_config_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.workflow_config_id_seq OWNED BY public.workflow_config.id;
...
--
-- Name: workflow_config id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workflow_config ALTER COLUMN id SET DEFAULT nextval('public.workflow_config_id_seq'::regclass);
...
--
-- Name: workflow_config workflow_config_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workflow_config
    ADD CONSTRAINT workflow_config_key_key UNIQUE (key);
...
--
-- Name: tool_calls tool_calls_lead_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tool_calls
    ADD CONSTRAINT tool_calls_lead_id_fkey FOREIGN KEY (lead_id) REFERENCES public.leads(id) ON DELETE SET NULL;
...
\unrestrict yv1TsoF2IPNGfl7mr4Oa2ay9weCw2kBtG7l2aYOVXjB5oyKZgzmPndctaIff1oo

--
-- PostgreSQL database dump
--

\restrict zdKZABTY7Cb63qFAo4cEbTVN1S85zqQ1f9DTfwLZNaFwzuqGfoALd4fIJiTAxT8
...
COPY public.workflow_config (id, key, workflow_id, workflow_name, description, is_active, created_at, updated_at) FROM stdin;
\.
...
--
-- Name: workflow_config_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.workflow_config_id_seq', 1, false);
...
\unrestrict zdKZABTY7Cb63qFAo4cEbTVN1S85zqQ1f9DTfwLZNaFwzuqGfoALd4fIJiTAxT8
